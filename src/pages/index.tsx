      ...
      <BoxContainer>
          ...
          <Grid container mt={3}>
            ...
            >
              ...
              <p style={{ marginTop: "16px", textAlign: "justify" }}>
                Create your card within 10 minutes ! The card will be ready to
                be viewed as soon you completed it
              </p>
            </Grid>
            <Grid
              item
        ...
        >
          <Box sx={{ mx: 6 }}>
            ...
            with variety tools we provided. Let your creativity colors your
            dream
          </Box>
          <Link
            href="/catalogue"
