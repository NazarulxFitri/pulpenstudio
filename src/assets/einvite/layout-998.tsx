    ...
    >
      ...
      >
        ...
        <MiniText
          ...
          dangerouslySetInnerHTML={{
            __html:
              "Kami dengan penuh kesyukuran ke hadrat Ilahi ingin mengundang Tan Sri / Puan Sri / Dato' Seri / Datin Seri / Dato' / Datin / Tuan / Puan / Encik / Cik  ke majlis perkahwinan puteri kesayangan kami",
          }}
        />
        <UbuntuText
          sx={{
