    ...
    >
      ...
      >
        <SubTitle
          ...
          sx={{ pb: 2, fontWeight: "bold", color: "#d7b332" }}
        />
        {!isCounting ? (
          <Box
            id="countdown"
          ...
          <Box
            ...
            columnGap={2}
            sx={{
              boxShadow: "1px 10px 10px -10px #d7b332",
              pb: 1,
              width: "fit-content",
              mx: "auto",
              display: "flex",
          ...
          >
            ...
            <Box>
              <Text
                style={{ fontSize: "48px", color: "#d7b332", width: "50px" }}
                dangerouslySetInnerHTML={{
